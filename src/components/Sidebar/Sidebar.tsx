...
const navItems = [
  ...
  { href: "/contact", label: "Contact", icon: Paperclip },
];
          ...
          <div className={styles.sidebarTop}>
            ...
            <div className={styles.logoRow}>
              <div className={styles.logoLeft}>
                <Link href="/" className={styles.logoIcon} onClick={closeMobile}>
                  <svg
                    width="28"
                    height="28"
                    viewBox="0 0 24 24"
                ...
                <Link href="/" className={styles.logoText} onClick={closeMobile}>
                  PORTFOLIO
                </Link>
              </div>
